...
if(isset($_GET["id_enviado"])){
    ...
    $resultado =$db->query("SELECT * FROM categoria_reporte WHERE id_categoria = ?",[$id_capturado]);
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre_categoria"  class="form-control rounded-pill px-3 py-2" value="<?php echo $fila['nombre_categoria']; ?>" required>
                                ...
                                <select name="id_area_municipal" class="form-select rounded-pill px-3 py-2" required>
                                    ...
                                    <?php foreach ($areas as $area) { ?>
                                        ...
                                        <option
                                            ...
                                            <?php if ($area['id_area'] == $fila['id_area_municipal']) echo "selected"; ?>
                                        >
