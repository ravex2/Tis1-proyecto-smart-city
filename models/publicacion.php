...
class Publicacion extends BaseModel {
    ...
    protected array $primaryKey = ['id_publicacion'];
    protected array $columns = ['contenido', 'titulo', 'fecha', 'fecha_evento', 'tipo_estado', 'lugar', 'imagen', 'visitas', 'id_funcionario', 'id_categoria'];
