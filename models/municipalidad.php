...
class Municipalidad extends BaseModel {
    protected string $table = 'municipalidad';
    protected array $primaryKey = ['id_municipalidad'];
    protected array $columns = ['nombre', 'comuna', 'region', 'direccion', 'telefono'];
