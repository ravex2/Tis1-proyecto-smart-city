...
class Comenta extends BaseModel {
    protected string $table = 'comenta';
    protected array $primaryKey = ['rut_usuario', 'id_comentario'];
    protected array $columns = ['rut_usuario', 'id_comentario'];
