...
class CategoriaReporte extends BaseModel {
    protected string $table = 'categoria_reporte';
    protected array $primaryKey = ['id_categoria'];
    protected array $columns = ['nombre_categoria', 'id_area_municipal', 'id_funcionario'];
