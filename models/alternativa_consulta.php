...
class AlternativaConsulta extends BaseModel {
    protected string $table = 'alternativa_consulta';
    protected array $primaryKey = ['id_alternativa'];
    protected array $columns = ['orden_alternativa', 'texto_alternativa', 'id_consulta_votacion'];
