...
class FuncionarioMunicipal extends BaseModel {
    protected string $table = 'funcionario_municipal';
    protected array $primaryKey = ['id_funcionario'];
    protected array $columns = ['rut_usuario', 'id_area_municipal'];
