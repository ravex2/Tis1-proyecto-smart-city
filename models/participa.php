...
class Participa extends BaseModel {
    protected string $table = 'participa';
    protected array $primaryKey = ['id_participacion', 'rut_usuario'];
    protected array $columns = ['id_participacion', 'rut_usuario'];
