...
class RevisionNegocio extends BaseModel {
    protected string $table = 'revision_negocio';
    protected array $primaryKey = ['id_revision'];
    protected array $columns = ['tipo_estado', 'observacion', 'id_funcionario'];
