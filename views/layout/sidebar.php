<nav class="col-md-2 d-none d-md-block sidebar px-4">
    <div class="sidebar-sticky">
        ...
        <ul class="nav flex-column gap-1">
            <li class="nav-item"><a class="nav-link" href="?ruta=inicio"><i class="bi bi-grid-fill me-2"></i> Dashboard</a></li>
            <li class="nav-item"><a class="nav-link" href="?ruta=reportes"><i class="bi bi-megaphone me-2"></i> Reportes</a></li>
            <li class="nav-item"><a class="nav-link" href="?ruta=sector"><i class="bi bi-map me-2"></i> Sector</a></li>
            <li class="nav-item"><a class="nav-link" href="?ruta=votaciones"><i class="bi bi-check2-square me-2"></i> Votaciones</a></li>
            <li class="nav-item"><a class="nav-link" href="?ruta=comercio"><i class="bi bi-shop me-2"></i> Emprendedores y Comercio</a></li>
            <li class="nav-item"><a class="nav-link" href="?ruta=rubros"><i class="bi bi-tag"></i> Rubro</a></li>
        </ul>
