    ...
    <div class="row">
        ...
        <main class="col-md-10 ms-sm-auto px-4">
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    <div>
                        <h3 class="fw-bold mb-1">Gestión de Reportes</h3>
                        <small class="text-muted">Moderación y administración de Reportes</small>
                    </div>
                    <div>
                                    ...
                                    if(count($resultado) > 0){
                                        foreach($resultado as $fila){
                                            ...
                                            echo "<tr>";
                                                ...
                                                echo "<td><a class='btn btn-primary rounded-pill px-5 fw-bold shadow-primary' href='?ruta=editar_categoria_reporte&id_enviado=".$id_categoria."'>Editar </a></td>";
                                                echo "<td><a class='btn btn-primary rounded-pill px-5 fw-bold shadow-primary' href='?ruta=eliminar_categoria_reporte&id_enviado=".$id_categoria."'>Eliminar </a></td>";
                                            echo "</tr>";
                                        }
                                    }else{
                                        echo    "<tr>
