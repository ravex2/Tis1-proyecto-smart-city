...
class ConsultaVotacion extends BaseModel {
    protected string $table = 'consulta_votacion';
    protected array $primaryKey = ['id_consulta'];
    protected array $columns = ['titulo', 'fecha_creacion', 'fecha_termino', 'pregunta', 'descripcion', 'tipo_consulta', 'tipo_estado', 'id_funcionario'];
