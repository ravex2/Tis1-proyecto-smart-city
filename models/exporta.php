...
class Exporta extends BaseModel {
    protected string $table = 'exporta';
    protected array $primaryKey = ['id_log_exportacion'];
    protected array $columns = ['tipo_formato', 'fecha', 'id_funcionario', 'id_reporte'];
