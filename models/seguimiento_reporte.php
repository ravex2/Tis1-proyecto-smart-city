...
class SeguimientoReporte extends BaseModel {
    protected string $table = 'seguimiento_reporte';
    protected array $primaryKey = ['id_seguimiento'];
    protected array $columns = ['observacion', 'imagen_evidencia', 'fecha', 'tipo_estado', 'id_funcionario', 'id_reporte'];
