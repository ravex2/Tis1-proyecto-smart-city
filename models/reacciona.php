...
class Reacciona extends BaseModel {
    protected string $table = 'reacciona';
    protected array $primaryKey = ['rut_usuario', 'id_reaccion'];
    protected array $columns = ['rut_usuario', 'id_reaccion'];
